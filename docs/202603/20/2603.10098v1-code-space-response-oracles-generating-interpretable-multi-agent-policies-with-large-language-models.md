...
tags: ["query:agent"]
score: 8.0
evidence: 在多智能体强化学习策略中用 LLM 替换强化学习 Oracle
...
method: 提出CSRO框架，将LLM作为策略预言机，通过代码生成、迭代优化和分布式进化算法合成可解释的算法行为。
result: 实验证明CSRO在多个领域达到了与基准方法相当的性能，并生成了一系列多样化且易于理解的人类级策略。
conclusion: 该研究将多智能体学习的重点从优化不透明参数转向合成可解释的代码策略，为构建可信的多智能体系统提供了新路径。
---
