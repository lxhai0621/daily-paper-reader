...
title_zh: 心领神会：通过人机协作中的共享第一人称视角实现认知对齐
...
## 摘要
尽管多模态人工智能取得了进展，但目前的视觉辅助工具在协作任务中往往效率低下。我们识别出两个关键鸿沟：一是沟通鸿沟，由于通道不匹配，用户必须将丰富的并行意图转化为口头指令；二是理解鸿沟，人工智能难以解释微妙的具身线索。为解决这些问题，我们提出了 Eye2Eye，这是一个利用第一人称视角作为人机认知对齐通道的框架。它集成了三个组件：(1) 用于流畅焦点对齐的共同注意力协调，(2) 用于维持不断演进的共识的可修订记忆，以及 (3) 允许用户澄清和完善人工智能理解的反思性反馈。我们在增强现实（AR）原型中实现了该框架，并通过用户研究和事后流水线评估对其进行了评估。结果表明，Eye2Eye 显著减少了任务完成时间和交互负载，同时增强了信任，证明了其各组件协同工作以改善协作。
